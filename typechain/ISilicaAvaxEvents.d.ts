...
interface ISilicaAvaxEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class ISilicaAvaxEvents extends BaseContract {
  ...
  interface: ISilicaAvaxEventsInterface;
