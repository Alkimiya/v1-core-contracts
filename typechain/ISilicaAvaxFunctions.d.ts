...
interface ISilicaAvaxFunctionsInterface extends ethers.utils.Interface {
  functions: {
...
export class ISilicaAvaxFunctions extends BaseContract {
  ...
  interface: ISilicaAvaxFunctionsInterface;
