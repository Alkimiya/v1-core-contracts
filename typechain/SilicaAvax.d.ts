...
interface SilicaAvaxInterface extends ethers.utils.Interface {
  functions: {
    ...
    "calculateRewardDueNextUpdate(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "calculateRewardDueNextUpdate",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
...
export class SilicaAvax extends BaseContract {
  ...
  functions: {
    ...
    calculateRewardDueNextUpdate(
      _daysPassed: BigNumberish,
