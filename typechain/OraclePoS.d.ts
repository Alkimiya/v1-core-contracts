...
interface OraclePoSInterface extends ethers.utils.Interface {
  functions: {
    ...
    "updateIndex(uint32,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,bytes)": FunctionFragment;
  };
  ...
  events: {
    "OracleUpdate(address,uint32,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)": EventFragment;
...
export type OracleUpdateEvent = TypedEvent<
  [
    ...
    supplyCap: BigNumber;
    maxStakingDuration: BigNumber;
    maxConsumptionRate: BigNumber;
    minConsumptionRate: BigNumber;
    mintingPeriod: BigNumber;
    scale: BigNumber;
    timestamp: BigNumber;
  }
>;
...
export class OraclePoS extends BaseContract {
  ...
  filters: {
    "OracleUpdate(address,uint32,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)"(
      caller?: string | null,
      referenceDay?: BigNumberish | null,
      referenceBlock?: BigNumberish | null,
      currentSupply?: null,
      supplyCap?: null,
      maxStakingDuration?: null,
      maxConsumptionRate?: null,
      minConsumptionRate?: null,
      mintingPeriod?: null,
      scale?: null,
      timestamp?: null
    ): TypedEventFilter<
