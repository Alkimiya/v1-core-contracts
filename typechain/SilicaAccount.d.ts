...
interface SilicaAccountInterface extends ethers.utils.Interface {
  functions: {
    "createSilicaContract(address,uint256,uint256,uint256)": FunctionFragment;
    "getAllContracts()": FunctionFragment;
    "getAvailableBalance()": FunctionFragment;
    "getBalance()": FunctionFragment;
    "getDailyBasisReward(uint256)": FunctionFragment;
    "getNetworkRewardAndHashrate(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "createSilicaContract",
  ...
  encodeFunctionData(
    functionFragment: "getDailyBasisReward",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getNetworkRewardAndHashrate",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class SilicaAccount extends BaseContract {
  ...
  interface: SilicaAccountInterface;

  functions: {
    createSilicaContract(
    ...
    getNetworkRewardAndHashrate(
      day: BigNumberish,
      overrides?: CallOverrides
    ): Promise<
      [BigNumber, BigNumber] & { hashrate: BigNumber; reward: BigNumber }
    >;
    ...
    silicaMaster(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    silicaMaster(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    silicaMaster(overrides?: CallOverrides): Promise<PopulatedTransaction>;
